...
function RequestedServices() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5550/api/getRequestServices/pending/${user._id}`).then((response) => {
                      ...
                      <td className="text-xs font-semibold text-blue-gray-500">
                        <div className=" flex justify-end sm:flex-row">
                          <div className="grid grid-cols-2 gap-4 justify-center">
                            <div className="justify-center" onClick={() => handlerequest(request._id, "accept")}>
